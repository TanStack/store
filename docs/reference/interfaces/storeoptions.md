...
Defined in: [store.ts:4](https://github.com/I-am-abdulazeez/store/blob/main/packages/store/src/store.ts#L4)
...
Defined in: [store.ts:17](https://github.com/I-am-abdulazeez/store/blob/main/packages/store/src/store.ts#L17)
...
Defined in: [store.ts:24](https://github.com/I-am-abdulazeez/store/blob/main/packages/store/src/store.ts#L24)
